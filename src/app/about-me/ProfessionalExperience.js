  ...
  return (
    <main className={styles.main} >
      ...
      <div className={styles.cards}>
        ...
        <div className={styles.card}>
          <ImageTextCard img={house} altTextImg={"House icon"} title={"2 clínicas"} subtitle={"Terapia com adultos"} />
        </div>

        <div className={styles.card}>
          <ImageTextCard img={girlPlaying} altTextImg={"Girl playing image"} title={"6 clínicas"} subtitle={"Terapia com crianças"} />
        </div>

        <div className={styles.card}>
          <ImageTextCard img={girlPlaying} altTextImg={"Girl playing image"} title={"Autismo?"} subtitle={"Algo sobre crianças c/ autismo"} />
        </div>
      </div>
